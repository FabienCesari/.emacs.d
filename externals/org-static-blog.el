...
(defcustom org-static-blog-publish-url "https://www.cesari.studio/"
  "URL of the blog."
  :type '(string)
  :safe t)

(defcustom org-static-blog-publish-title "cesari.studio"
  "Title of the blog."
  :type '(string)
  :safe t)

(defcustom org-static-blog-publish-directory "~/work/blog/"
  "Directory where published HTML files are stored."
  :type '(directory))

(defcustom org-static-blog-posts-directory "~/work/blog/posts/"
...
(defcustom org-static-blog-drafts-directory "~/work/blog/drafts/"
...
For example, when `org-static-blog-posts-directory` is set to '~/work/blog/posts'
and `post-filename` is passed as '~/work/blog/posts/my-life-update.org' then the function
